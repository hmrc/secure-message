...
case class SA309C_v1ContentParams(taxYear: TaxYear, onlineDeadline: LocalDate)

object SA309C_v1ContentParams {
  ...
  implicit val jsonFormat: Format[SA309C_v1ContentParams] =
    Json.format[SA309C_v1ContentParams]
}

case object TemplateSA309C_v1 extends SATemplates {
  val templateKey = "SA309C_v1"

  def render(renderingData: RenderingData)(implicit messages: Messages): HtmlFormat.Appendable =
    html.SA309C_v1(
      renderingData.contentParametersData.as[SA309C_v1ContentParams],
