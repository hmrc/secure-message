...
import uk.gov.hmrc.securemessage.templates.satemplates.helpers.{ Render, RenderingData, TaxYear }

import java.time.{ Instant, LocalDate }
import scala.concurrent.{ ExecutionContext, Future }
import scala.util.matching.Regex

case class SA309A_v1ContentParams(taxYear: TaxYear, onlineDeadline: LocalDate)

object SA309A_v1ContentParams {
  ...
  implicit val jsonFormat: Format[SA309A_v1ContentParams] =
    Json.format[SA309A_v1ContentParams]
}

case object TemplateSA309A_v1 extends SATemplates {
  val templateKey = "SA309A_v1"

  def render(renderingData: RenderingData)(implicit messages: Messages): HtmlFormat.Appendable =
    html.SA309A_v1(
      renderingData.contentParametersData.as[SA309A_v1ContentParams],
