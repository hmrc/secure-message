...
import uk.gov.hmrc.securemessage.models.core.{ MessageV4, MessageV4Mongo }

import javax.inject.{ Inject, Singleton }
import scala.concurrent.{ ExecutionContext, Future }

@Singleton
class MessageV4Repository @Inject()(mongo: MongoComponent)(implicit ec: ExecutionContext)
    extends PlayMongoRepository[MessageV4](
      mongo,
      "message_v4",
      MessageV4Mongo.mongoMessageFormat,
      Seq(
        IndexModel(
          ascending("hash"),
  ...
  def save(message: MessageV4): Future[Boolean] =
