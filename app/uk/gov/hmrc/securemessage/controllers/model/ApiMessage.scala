...
object ApiMessage {
  implicit val apiMessageFormat: Format[ApiMessage] = new Format[ApiMessage] {
    override def reads(json: JsValue): JsResult[ApiMessage] =
      json.validate[ApiConversation] orElse json.validate[ApiLetter]
